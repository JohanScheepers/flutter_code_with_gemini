...
class RulesPage extends StatelessWidget {
  ...
  Widget _buildRuleItem(BuildContext context, String text,
    ...
    final RegExp exp =
        RegExp(r'\*\*(.*?)\*\*'); // Regex to find **bolded text**
    int currentIndex = 0;
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          ExpansionTile(
            title: const Text('1. Project Setup & Structure',
                style: TextStyle(color: Colors.black)), // Title to black
          ...
          ExpansionTile(
            title: const Text('2. Coding Standards & Style',
                style: TextStyle(color: Colors.black)), // Title to black
            expandedCrossAxisAlignment: CrossAxisAlignment.start,
            children: _buildSubPoints(context, '''
          ...
          ExpansionTile(
            title: const Text('3. Widget Design & Composition',
                style: TextStyle(color: Colors.black)), // Title to black
            expandedCrossAxisAlignment: CrossAxisAlignment.start,
            children: _buildSubPoints(context, '''
          ...
          ExpansionTile(
            title: const Text('4. State Management',
                style: TextStyle(color: Colors.black)), // Title to black
            expandedCrossAxisAlignment: CrossAxisAlignment.start,
            children: _buildSubPoints(context, '''
          ...
          ExpansionTile(
            title: const Text('5. Asynchronous Operations & Error Handling',
                style: TextStyle(color: Colors.black)), // Title to black
            expandedCrossAxisAlignment: CrossAxisAlignment.start,
            children: _buildSubPoints(context, '''
          ...
          ExpansionTile(
            title: const Text('7. Dependencies & Packages',
                style: TextStyle(color: Colors.black)), // Title to black
            expandedCrossAxisAlignment: CrossAxisAlignment.start,
            children: _buildSubPoints(context, '''
          ...
          ExpansionTile(
            title: const Text('9. Performance',
                style: TextStyle(color: Colors.black)), // Title to black
            expandedCrossAxisAlignment: CrossAxisAlignment.start,
            children: _buildSubPoints(context, '''
          ...
          ExpansionTile(
            title: const Text('10. Code Documentation & Comments',
                style: TextStyle(color: Colors.black)), // Title to black
            expandedCrossAxisAlignment: CrossAxisAlignment.start,
            children: _buildSubPoints(context, '''
              1.  **Dartdocs**: ...
          ...
          ExpansionTile(
            title: const Text('11. Security Considerations',
                style: TextStyle(color: Colors.black)), // Title to black
            expandedCrossAxisAlignment: CrossAxisAlignment.start,
            children: _buildSubPoints(context, '''
          ...
          ExpansionTile(
            title: const Text('12. User Experience (UX) Focus',
                style: TextStyle(color: Colors.black)), // Title to black
            expandedCrossAxisAlignment: CrossAxisAlignment.start,
            children: _buildSubPoints(context, '''
          ...
          ExpansionTile(
            title: const Text('13. Version Control Practices',
                style: TextStyle(color: Colors.black)), // Title to black
            expandedCrossAxisAlignment: CrossAxisAlignment.start,
            children: _buildSubPoints(context, '''
          ...
          ExpansionTile(
            title: const Text('14. Continuous Improvement',
                style: TextStyle(color: Colors.black)), // Title to black
            expandedCrossAxisAlignment: CrossAxisAlignment.start,
            children: _buildSubPoints(context, '''
